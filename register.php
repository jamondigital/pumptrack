...
<header class="page-header page-header--register">
	<h1 class="heading--small">Register Now</h1>
	<img src="/assets/img/logo-redbullpumtrackworldchampionship.png" height="568" width="1000" alt="" class="brand brand--rbptwc brand--rbptwc-small">
</header>
<main role="main">
	<section class="page-section page-section--register">
		<div class="page-section__inner">
			...
			<form class="form-register" action="confirmation.php" method="post">
				...
				<fieldset>
					<div class="form-group form-group--radio">
						<div class="form-group__item-inline">
							<input type="radio" name="gender" value="female" id="gender_female" checked="checked">
							<div class="radio"></div>
							<label for="gender_female" class="control-label">
								<span>Female</span>
							</label>
						</div>
						<div class="form-group__item-inline">
							...
							<div class="radio"></div>
							<label for="gender_male" class="control-label">
								<span>Male</span>
							</label>
						</div>
					</div>
				...
				<div class="form-disclaimer">Our goal is to make the Red Bull Pump Track World Championship as accessible as possible! Entrance fees will vary dependent on your country but we aim to keep costs affordable and no more than the average price of an inner tube at your local shop!</div>
				<fieldset>
					<div class="form-group form-group--button">
						<input type="submit" class="btn btn--primary btn--submit" name="btnSubmit" value="Submit">
					</div>
				</fieldset>
			</form>
		</div>
